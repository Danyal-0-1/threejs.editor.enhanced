<!-- GENERATED FILE — do not edit.
   ...
   to change the lexicon, edit candidates/phi_gamma.json and re-render. -->

# Railroad Diagram — `chain_expression` (lexicon: gamma)
...
optionality, so `◈⏧()` and `◈⏦('#f00')` are both covered by
one box.
